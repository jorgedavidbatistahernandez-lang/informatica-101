 ...
 * EVALUACIONES
 *************************/
const evaluaciones = [...]; // ← EXACTAMENTE IGUAL A TU CÓDIGO (NO TOCADO)
...
function ordenarTabla(columna) {
    alumnos.sort((a, b) => {
        ...
        if (columna === 0) {
            ...
            valorA = calcularPromedio(a) === "—" ? -1 : parseFloat(calcularPromedio(a));
            valorB = calcularPromedio(b) === "—" ? -1 : parseFloat(calcularPromedio(b));
        }
...
/*************************
 * CONECTAR ENCABEZADOS
 *************************/
document.querySelectorAll("#tablaAlumnos thead th").forEach((th, i) => {
    if (i < 3) {
